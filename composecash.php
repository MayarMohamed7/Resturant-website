...
<img title="Cairo GRND Restaurant" style="padding:10px;" src="Cairo GRND Restaurant.png"alt="Cairo GRND Restaurant" width="110" height="120">
<br><br>
<style>
...
h2{
font-family: "Scope One", Times, serif;
...
<div style="background-color:rgba(255,255,255,0.9);">
  ...
  <form action = "additemcash.php" method = "post">
   ...
   Quantity: <input type = "number" name = "qty" min = "1" max = "10" class="form-control">
